   ...
   public function __construct()
   {
    ...
    public function listgrid(Request $request){
       // $permissionData=$this->getPagePermission($request,37);
        //dd($permissionData);
     $query='SELECT prp_physical_planned,prp_budget_planned,prp_quarter_id,prp_budget_by_region,prp_physical_by_region,prp_budget_baseline, prp_physical_baseline,
