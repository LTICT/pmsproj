...
class PmscitizenshipprojectController extends MyController
{
 public function __construct()
 {
    ...
    {
        $query='SELECT prj_cluster_id,owner_zone.add_name_or AS zone_owner,
...
$query .= " LEFT JOIN gen_address_structure location_woreda ON pms_project.prj_location_woreda_id = location_woreda.add_id";
        ...
        $query .=" WHERE prj_id=".$id." AND prj_owner_type=3 ";
    ...
    public function listgrid(Request $request){
      ...
      $query="SELECT prj_cluster_id,prj_male_participant,prj_female_participant,prj_sub_project_category_id,prj_job_opportunity,sci_name_en AS sector_name,prs_color_code AS color_code,prs_id AS status_id, prs_status_name_en AS status_name,(zone_info.add_name_or || '-' || woreda_info.add_name_or) AS zone_name, prj_name_en,prj_name_am,prj_department_id,prj_id,prj_name,prj_code, prj_project_status_id,prj_project_category_id,prj_total_estimate_budget,prj_total_actual_budget,
        ...
        $query .=' LEFT JOIN pms_project_status ON pms_project_status.prs_id= pms_project.prj_project_status_id';
        $query .=' LEFT JOIN gen_address_structure zone_info ON zone_info.add_id= pms_project.prj_location_zone_id';
        $query .=' LEFT JOIN gen_address_structure woreda_info ON woreda_info.add_id= pms_project.prj_location_woreda_id';
