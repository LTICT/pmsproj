...
class PmsbudgetrequestapprovalController extends MyController
{
   public function __construct()
   {
    ...
    //get user info from logged in user
            ...
            $query='SELECT bdr_physical_baseline,bdr_financial_baseline,bdr_physical_planned,bdr_request_type, bdr_request_category_id, rqs_description AS color_code, rqs_name_en AS status_name,
