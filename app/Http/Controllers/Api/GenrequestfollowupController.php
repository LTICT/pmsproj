...
class GenrequestfollowupController extends MyController
{
   public function __construct()
   {
    ...
    public function listgrid(Request $request){
     $query="SELECT rqf_id,rqf_request_id,rqf_forwarding_dep_id,rqf_forwarded_to_dep_id,rqf_forwarding_date,rqf_received_date,rqf_description,rqf_create_time,rqf_update_time,rqf_delete_time,rqf_created_by,rqf_status,1 AS is_editable, 1 AS is_deletable FROM gen_request_followup ";
