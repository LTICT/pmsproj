...
class PmscsoinfoController extends MyController
{
   public function __construct()
   {
    ...
    public function listgrid(Request $request){
     $query="SELECT cso_id,cso_name,cso_code,cso_address,cso_phone,cso_email,cso_website,cso_description,cso_create_time,cso_update_time,cso_delete_time,cso_created_by,cso_status,1 AS is_editable, 1 AS is_deletable FROM pms_cso_info ";
     $query .=' WHERE 1=1';
