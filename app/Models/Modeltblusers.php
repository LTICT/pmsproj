...
class Modeltblusers extends Model
{
    ...
    */
    ...
    'usr_description','usr_create_time','usr_update_time','usr_delete_time','usr_created_by','usr_status','email','password','usr_directorate_id','usr_team_id','usr_officer_id','usr_owner_id'];
